...
-- CreateTable
CREATE TABLE "ExercisePeriodVolumeGoal" (
    "id" SERIAL NOT NULL,
    "userId" INTEGER NOT NULL,
    ...
    CONSTRAINT "ExercisePeriodVolumeGoal_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ExercisePeriodVolumeGoal" ADD CONSTRAINT "ExercisePeriodVolumeGoal_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ExercisePeriodVolumeGoal" ADD CONSTRAINT "ExercisePeriodVolumeGoal_exerciseId_fkey" FOREIGN KEY ("exerciseId") REFERENCES "Exercise"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
