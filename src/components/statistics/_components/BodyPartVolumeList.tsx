...
import type { BodyPartVolumeTotal } from '@/server/application/services/StatisticsService'
...
export default function BodyPartVolumeList({ data, granularity, onGranularityChange }: Props) {
  if (data.length === 0) {
    return (
