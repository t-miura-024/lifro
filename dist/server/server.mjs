...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-2uBQIJyu.mjs");
...
const manifest = {
  "d7f7afd587c2e73a5fabe15fd9dde630f3813b9d6699f72c3e89c216fe6aeb19": {
    functionName: "getSessionUserIdServerFn_createServerFn_handler",
    importer: () => import("./assets/auth-session-server-CGTLfOzs.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./assets/router-Bm5ENF0-.mjs").then((n) => n.r),
    import("./assets/start-HYkvq4Ni.mjs"),
    import("./assets/empty-plugin-adapters-BFgPZ6_d.mjs")
  ]);
  return {
    routerEntry,
    startEntry,
